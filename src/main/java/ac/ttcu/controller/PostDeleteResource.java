...
@RestController
@RequestMapping("/api")
public class PostDeleteResource {
    private final PostService postService;
    Logger logger = LoggerFactory.getLogger(PostDeleteResource.class);

    public PostDeleteResource(PostService postService) {
    ...
    public ResponseEntity<Message> fetchPosts(@RequestBody PostDTO postDTO,
        ...
        Message message;
        try {
            logger.info("Delete post: {}", postDTO.getId());
